!(function (e) {
      ...
      return this.each(function () {
        ...
        t.find("li").each(function () {
          ...
          t.addClass(s.subMenuClass),
            ...
            t.prev("a").addClass(s.meanExpandClass),
            t.next("a").addClass(s.meanExpandClass);
        });
        ...
        e(a).each(function () {
          e(this).on("click", function (t) {
            var n;
            t.preventDefault(),
              e((n = this)).next("ul").length > 0
                ? (e(n).parent().toggleClass(s.subMenuParentToggle),
                  e(n).next("ul").slideToggle(s.toggleSpeed),
                  e(n).next("ul").toggleClass(s.subMenuToggleClass))
                : e(n).prev("ul").length > 0 &&
                  (e(n).parent().toggleClass(s.subMenuParentToggle),
                  e(n).prev("ul").slideToggle(s.toggleSpeed),
                  e(n).prev("ul").toggleClass(s.subMenuToggleClass));
          });
        }),
  ...
  e(window).on("scroll", function () {
    ...
    (n = e(".sticky-active")),
      ...
      e(window).scrollTop() > 800
        ? (n.parent().addClass(o), i > t ? n.removeClass(a) : n.addClass(a))
        : (n.parent().css("min-height", "").removeClass(o), n.removeClass(a)),
      (t = i),
    ...
    e(".price-plan-slide").slick({
      ...
      centerPadding: "555px",
      prevArrow:
        '<button type="button" class="slick-prev"><i class="long-arrow"></i></button>',
      nextArrow:
        '<button type="button" class="slick-next"><i class="long-arrow"></i></button>',
      responsive: [
        {
          breakpoint: 1700,
          settings: { centerPadding: "300px", slidesToShow: 1 },
        },
        { breakpoint: 1450, settings: { centerPadding: "200px" } },
        { breakpoint: 1199, settings: { centerPadding: "100px", arrows: !1 } },
        { breakpoint: 992, settings: { centerPadding: "50px", arrows: !1 } },
        { breakpoint: 767, settings: { centerPadding: "0", arrows: !1 } },
      ],
    }),
    ...
    (e.fn.sectionPosition = function (t, s) {
      e(this).each(function () {
        var a,
          ...
          l,
          c = e(this);
        (a = Math.floor(c.height() / 2)),
          (o = c.attr(t)),
          (i = c.attr(s)),
          (r = n(e(i).css("padding-top"))),
          (l = n(e(i).css("padding-bottom"))),
          "top-half" === o
            ? (e(i).css("padding-bottom", l + a + "px"),
              c.css("margin-top", "-" + a + "px"))
            : "bottom-half" === o &&
              (e(i).css("padding-top", r + a + "px"),
              c.css("margin-bottom", "-" + a + "px"));
      });
    });
  var a,
    o,
  ...
  e(r).length &&
    ...
    e(".offers-slide").slick({
      ...
      centerPadding: "378px",
      responsive: [
        { breakpoint: 1800, settings: { centerPadding: "260px" } },
        { breakpoint: 1350, settings: { centerPadding: "150px" } },
        { breakpoint: 992, settings: { centerPadding: "100px" } },
        { breakpoint: 767, settings: { centerPadding: "60px" } },
        { breakpoint: 576, settings: { centerPadding: "0" } },
      ],
    }),
    e(".team-toggler-btn").length > 0 &&
      e(".team-toggler-btn").each(function () {
        e(this).on("click", function (t) {
          t.preventDefault(),
            e(this).hasClass("active")
              ? (e(this).removeClass("active"),
                e(this).parent().parent().removeClass("toggled"),
                e(this).siblings(".team-social").removeClass("show"))
              : (e(".team-toggler-btn.active")
                  .parent()
                  .parent()
                  .removeClass("toggled"),
                e(".team-toggler-btn.active").removeClass("active"),
                e(".team-social.show").removeClass("show"),
                e(this).addClass("active"),
                e(this).parent().parent().addClass("toggled"),
                e(this).siblings(".team-social").addClass("show"));
        });
      }),
